        ...
        <div class="content-card-body" style="padding: 24px;">
            <form action="{{ route('personas.update', $persona) }}" method="POST">
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <input type="text" name="ci" id="ci" value="{{ old('ci', $persona->ci) }}" required style="width: 100%; padding: 10px 14px; border: 1px solid #cbd5e1; border-radius: 6px; font-size: 14px; color: #1e293b; outline: none; transition: border-color 0.2s;">
                    @error('ci')
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $persona->nombre) }}" required style="width: 100%; padding: 10px 14px; border: 1px solid #cbd5e1; border-radius: 6px; font-size: 14px; color: #1e293b; outline: none; transition: border-color 0.2s;">
                    @error('nombre')
                        <p style="color: #ef4444; font-size: 12px; margin-top: 4px;">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div style="margin-bottom: 24px;">
                    ...
                    <input type="text" name="telefono" id="telefono" value="{{ old('telefono', $persona->telefono) }}" style="width: 100%; padding: 10px 14px; border: 1px solid #cbd5e1; border-radius: 6px; font-size: 14px; color: #1e293b; outline: none; transition: border-color 0.2s;">
                    @error('telefono')
                        <p style="color: #ef4444; font-size: 12px; margin-top: 4px;">{{ $message }}</p>
                    @enderror
                </div>
